                ...
                try
                {
                    try
                    {
                        AbstractInsnNode node = MethodInsnNode.class.getConstructor(int.class, String.class, String.class, String.class).newInstance(
                                INVOKESTATIC, "com/mc6m/mod/dlampmod/dynamiclights/client/DynamicLights", "getLightValue", "(L"+blockAccessJava+";L"+blockJava+";III)I");
                        toInject.add(node);
                    }
                    catch (NoSuchMethodException e)
                    {
                        AbstractInsnNode node = MethodInsnNode.class.getConstructor(int.class, String.class, String.class, String.class, boolean.class).newInstance(
                                INVOKESTATIC, "com/mc6m/mod/dlampmod/dynamiclights/client/DynamicLights", "getLightValue", "(L"+blockAccessJava+";L"+blockJava+";III)I", false);
                        toInject.add(node);
                    }
                }
                catch (Exception e)

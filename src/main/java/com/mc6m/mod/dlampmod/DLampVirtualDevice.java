...
//    void setTempRGB(int r, int g, int b, SetColorType sct) {
//        if (getIsOpen(sct)) {
...
//    void flash(int r, int g, int b, int millisec, SetColorType sct) {
//        if (getIsOpen(sct)) {
//            if (flashing) {
//                timer.cancel();
//                timer = new Timer();
...
//    }
//
//    void timedFlash(final int r, final int g, final int b, int period, SetColorType sct) {
//        if (getIsOpen(sct)) {
//            stopTimedFlash();
//            timedflashing = true;
////            device.setRGB(0, 0, 0);
//            device.setBlink(new int[]{r, g, b}, period, period);
